...
export function WpApiLoaderFactory(http : Http) {
  return new WpApiStaticLoader(http, 'http://wpapp.dev/wp-json/'
...
import {TileBlankPipe} from './tile-blank.pipe';
...
@NgModule({
  declarations: [
    ...
    UiSettingsComponent,
    UiPlaytabComponent,
    UiMovelistComponent, UiTrackingComponent,
    TileBlankPipe,
    SanitizeHtmlPipe
  ],
  imports: [
    NgSpinKitModule, CoolStorageModule, TagCloudModule, BrowserModule, WpApiModule.forRoot({provide: WpApiLoader, useFactory: WpApiLoaderFactory, deps: [Http]}),
    FormsModule,
    HttpModule,
    NgbModule.forRoot(),
